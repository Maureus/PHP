<template>
    <div class="flex flex-row pt-4">
        ...
        <div v-if="getShowModalConfirm" class="absolute inset-0 flex items-center justify-center bg-gray-600 bg-opacity-50">
            ...
            <div v-if="editProfile" >
                <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <button :disabled="!curUser.name" @click.prevent="saveUserProfile" class="py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-500 focus:outline-none focus:shadow-outline-blue active:bg-indigo-600 transition duration-150 ease-in-out">
                                Save
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input id="repeat_password" class="mt-1 form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" v-model="password_confirmation" name="repeatPassword">
                                </div>
                            </div>
                        </div>
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
